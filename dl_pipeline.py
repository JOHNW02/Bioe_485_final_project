...
if __name__ == '__main__':
	...
	parser = argparse.ArgumentParser(description="Execute Train")
	parser.add_argument('--deep', type=str, default="True", help="...")
	parser.add_argument('--pretrain', type=str, default="True", help="...")
	args = parser.parse_args()

	if args.deep=="True":
		depth = True
	else if args.deep=="False":
		depth = False
	else 
	...
	# Plot loss curve
	num_epoch = np.arange(len(train_loss_history) )

	plt.plot(num_epoch, train_loss_history, label="train")
	plt.plot(num_epoch, valid_loss_history, label="valid")
	plt.xlabel('epoch')
	plt.ylabel('Loss')
	plt.title("Loss curves")
	plt.legend()
	plt.savefig(f"loss_curves_deep{args.deep}_pre{args.pretrain}.png")
