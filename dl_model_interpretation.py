...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt', type=str, default="True", help="...")
    ...
    # Grad Cam
    # Find predicted=True images and extract the features
    true_0_idx = []
    true_1_idx = []
    true_2_idx = []
    true_3_idx = []
    ...
    to_produce_list = [true_0_idx[0], true_1_idx[7], true_2_idx[2], true_3_idx[0], true_4_idx[1] ]
    heldout_img_idx = heldout_indices[to_produce_list]
    img_names = image_names[heldout_img_idx]
    print(img_names)
    target_layers = [model[9]]
